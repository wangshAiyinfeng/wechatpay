...
<script>
    /*公众号支付*/
    function gzhPay() {
        var url = "http://xiaoxiaofengsi.ngrok.xiaomiqiu.cn/Pay/wc/gzhPay.do?total_fee=100"; //注意此处的basePath是没有端口号的域名地址。如果包含:80,在提交给微信时有可能会提示 “redirect_uri参数错误” 。
        //money为订单需要支付的金额
        //state中存放的为商品订单号
        console.log(url);//snsapi_userinfo
        var weixinUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxba7178cc76cb5f2d&redirect_uri=" + encodeURI(url) + "&response_type=code&scope=snsapi_base&state=state#wechat_redirect";
